...
const Conversation = ({ conversation }: { conversation: any }) => {
	...
	return (
		<>
			<div className={` flex gap-2 items-center p-3 hover:bg-chat-hover cursor-pointer ${currentActiveConversation ? ' bg-gray-tertiary' : '' } `} onClick={() =>setSelectedConversation(conversation)}>
